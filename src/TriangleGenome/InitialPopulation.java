 ...
 * 
 * Note the initial population is currently a random genome
 * from the tribe. We are going to have to calculate the fitness
 * of each member of the tribe and select the fittest member most likely
 * but I have not included this yet since it would drastically slow down
 * the program which is not helpful for testing. 
 */
